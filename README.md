...
## Cyfarwyddiadau Defnydd yr Anonymeiddiwr
Mae’r Anonymeiddiwr Beta yn raglen Python sydd angen Python 3.8 neu'n ddiweddarach i redeg. Mae'n rhaid rhedeg yr Anonymeiddiwr ar y llinell orchymyn. Rhaid i chi hefyd fod wedi gosod pecyn llyfrgell spaCy o flaen llaw (gweler https://spacy.io/usage), ac argymhellwn lwytho’r model mawr (en_web_core_lg) i lawr er mwyn pweru’r Adnabod Endidau. Mae'r tagio rhannau ymadrodd Cymraeg yn defnyddio'r model sy'n gynwysiedig gyda'r pecyn hwn. 
